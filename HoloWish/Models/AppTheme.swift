...
private struct TalentThemeDefinition {
    ...
    static let all: [TalentThemeDefinition] = [
        ...
        .init(name: "Achichi Mela", japaneseName: "熱千めら", portraitFileName: "Achichi-Mela_list_thumb.png", category: .holoAN, status: nil, accent: 0x5B69DA, secondaryAccent: 0x59A8E2),
        .init(name: "Sorashina Sopia", japaneseName: "宙科そぴあ", portraitFileName: "Sorashina-Sopia_list_thumb.png", category: .holoAN, status: nil, accent: 0x695FE8, secondaryAccent: 0x32A5E9),
        .init(name: "Suzuna Tsuzuri", japaneseName: "鈴鳴つづり", portraitFileName: "Suzuna-Tsuzuri_list_thumb.png", category: .holoAN, status: nil, accent: 0xBC1F27, secondaryAccent: 0xE370B8),
        .init(name: "Hyakuto Kyoko", japaneseName: "百灯キョーコ", portraitFileName: "Hyakuto-Kyoko_list_thumb.png", category: .holoAN, status: nil, accent: 0xE2712F, secondaryAccent: 0x96D122),
